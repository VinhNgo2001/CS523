...
activation_input=st.sidebar.selectbox("activation input",("relu","sigmoid","tanh","linear"))
...
for i in range(0,hiddenlayer):
    ...
    node.append(a)
    b=st.sidebar.selectbox("activation "+str(i+1),("relu","sigmoid","tanh","linear"))
    acc.append(b)
activation_output=st.sidebar.selectbox("activation output",("relu","sigmoid","tanh","linear"))
...
if file:
    ...
    properties=st.selectbox("Select properties",df.columns)
